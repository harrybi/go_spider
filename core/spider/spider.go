...
import (
	...
	"github.com/harrybi/go_spider/core/common/page_items"
	"github.com/harrybi/go_spider/core/common/request"
	"github.com/harrybi/go_spider/core/common/resource_manage"
	"github.com/harrybi/go_spider/core/downloader"
	"github.com/harrybi/go_spider/core/page_processer"
	"github.com/harrybi/go_spider/core/pipeline"
	"github.com/harrybi/go_spider/core/scheduler"
	"math/rand"
	//"net/http"
	"time"
	//"fmt"
...
func (this *Spider) SetCharset(charset string) *Spider {
	this.pDownloader.Charset = charset
	return this
}
